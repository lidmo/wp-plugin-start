...
use WPPluginStart\Traits\Settings as SettingsFields;
...
class Settings {
    ...
    public function __construct() {
        ...
        $this->plugin_slug  = PREFIX_PLUGIN_NAME;
        $this->textdomain   = str_replace('_', '-', PREFIX_PLUGIN_NAME);
    ...
    public function addSettingsMenu(){
        $page = add_submenu_page( $this->plugin_slug,'WPPluginStart Settings', 'Settings', 'manage_options' , $this->plugin_slug . '-settings',  array( $this, 'settingsPage' ) );
    }
    public function addSettingsLink( $links, $plugin_file, $plugin_data, $context ) {
//        echo $plugin_file;
        if($plugin_file === str_replace(WP_PLUGIN_DIR . '/', '', PREFIX_PLUGIN_FILE)) {
